...
function loadProductImage(img,p){if(!img||!p)return;const c=getImageCandidates(p);let i=0;const next=()=>{if(i>=c.length){img.onerror=null;img.classList.add("image-failed");return}img.src=encodeURI(c[i++])};img.onerror=next;next()}
